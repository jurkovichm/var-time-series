...
It is also wise to test for autocorrelation within the residuals of VAR(*p*) models to avoid standard erros being too small or T-statistics that are too large. Do to this within a VAR(*p*) setting we can conduct a Portmanteau test of the form
